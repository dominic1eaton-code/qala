...
components: design, blueprint, version number
data: id, part number, dimensions, parts
parts: handle, bit shank, grip
   -  handle: dimensions, material, color, part number, shape design
        - material number, material type, material ID (e.g. plastic type, identification number)
    - shank: material, part number
    - bit: shape, 
